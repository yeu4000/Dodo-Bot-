...
//GENEL KOMUTU
    if(args[0] === "Genel" || args[0] === "genel" || args[0] === "General" || args[0] === "general") {
              ...
              .setAuthor({ name: 'Genel', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://discord.gg/mg2MW3MsQs' })
              .setColor('#2667FF')
    ...
    //SUNUCU KOMUTU
      if(args[0] === "Sunucu" || args[0] === "sunucu") {
              ...
              .setAuthor({ name: 'Sunucu', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://https://discord.gg/mg2MW3MsQs' })
              .setColor('#2667FF')
...
//EĞLENCE KOMUTU
  if(args[0] === "Eğlence" || args[0] === "eğlence" || args[0] === "Fun" || args[0] === "fun") {
   ...
   .setAuthor({ name: 'Eğlence', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://https://discord.gg/mg2MW3MsQs' })
   .setColor('#2667FF')
  ...
  if(args[0] === "Moderasyon" || args[0] === "moderasyon" || args[0] === "moderation" || args[0] === "Moderation") {
   ...
   .setAuthor({ name: 'Moderasyon', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://discord.gg/mg2MW3MsQs' })
   .setColor('#2667FF')
  ...
  if(args[0] === "Sahip" || args[0] === "sahip" ) {
    ...
    .setAuthor({ name: 'Sahip', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://discord.gg/mg2MW3MsQs' })
    .setColor('#2667FF')
...
//YARDIM KOMUTU
  ...
  .setAuthor({ name: 'Yardım', iconURL: `${message.author.displayAvatarURL()}`, url: 'https://discord.gg/mg2MW3MsQs' })
  .setColor('#FFFB05')
